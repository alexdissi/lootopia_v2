    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Les couronnes sont la monnaie virtuelle de Lootopia. Elles vous permettent de participer à des chasses au trésor exclusives.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex flex-col space-y-4 py-4">
          <div className="flex justify-between items-center p-3 bg-muted/50 rounded-lg">
            ...
            <div className="text-xl font-bold text-amber-500">{data?.amount?.toLocaleString() ?? "0"}</div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="text-sm text-muted-foreground">
              ...
              <p className="py-1 border-b">+ 50 couronnes • Participation à la chasse "Trésors de Paris"</p>
              <p className="py-1 border-b">- 100 couronnes • Inscription à la chasse "Énigmes de Lyon"</p>
              <p className="py-1">+ 200 couronnes • Victoire à la chasse "Mystères de Marseille"</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-between">
          ...
          <Button variant="default" className="bg-amber-500 hover:bg-amber-600">Obtenir plus de couronnes</Button>
        </div>
      </DialogContent>
    </Dialog>
  );
